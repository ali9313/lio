...
@l313l.ar_cmd(
    ...
    info={
        "header": "To list all plugins in aliup.",
        "usage": "{tr}plugins",
    },
)
async def _(event):
...
@l313l.ar_cmd(
    ...
    info={
        "header": "To list all environment values in aliup.",
        "description": "to show all heroku vars/Config values in your aliup",
        "usage": "{tr}env",
    },
)
async def _(event):
    "To show all config values in aliup"
    cmd = "env"
    o = (await _catutils.runcmd(cmd))[0]
    OUTPUT = (
