...
ali_users = []
ali_mute = "https://telegra.ph/file/c5ef9550465a47845c626.jpg"
ali_unmute = "https://telegra.ph/file/e9473ddef0b58cdd7f9e7.jpg"
...
async def show_muted_users(event):
    if len(ali_users) > 0:
        ali_list = "** قائمة المستخدمين المكتومين:**\n"
        for i, user in enumerate(joker_users, start=1):
            ali_link = f"[{user.first_name}](tg://user?id={user.id})"
            ali_list += f"{i}. {joker_link}\n"
