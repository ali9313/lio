import sys
import aliup
from aliup import BOTLOG_CHATID, HEROKU_APP, PM_LOGGER_GROUP_ID
...
print(aliup.__copyright__)
print("Licensed under the terms of the " + aliup.__license__)
...
async def externalrepo():
    if Config.VCMODE:
        await install_externalrepo("https://github.com/ali9313/JepVc", "jepvc", "jepthonvc")
